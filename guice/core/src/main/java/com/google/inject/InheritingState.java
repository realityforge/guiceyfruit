...
class InheritingState implements State {
  ...
  private final List<ConstructorAspect> constructorAspects = Lists.newArrayList();
  ...
  public void addConstructorAspect(ConstructorAspect constructorAspect) {
    constructorAspects.add(constructorAspect);
  }

  public List<ConstructorAspect> getConstructorAspects() {
    List<ConstructorAspect> result = Lists.newArrayList();
    result.addAll(parent.getConstructorAspects());
    result.addAll(constructorAspects);
    return result;
  }
